...
namespace ImGuiMCP {
    ...
    #endif
#endif
#define IM_COL32(R, G, B, A) (((ImGuiMCP::ImU32)(A) << IM_COL32_A_SHIFT) | ((ImGuiMCP::ImU32)(B) << IM_COL32_B_SHIFT) | ((ImGuiMCP::ImU32)(G) << IM_COL32_G_SHIFT) | ((ImGuiMCP::ImU32)(R) << IM_COL32_R_SHIFT))
...
#define IM_COL32_BLACK_TRANS IM_COL32(0, 0, 0, 0)    // Transparent black = 0x00000000
    ...
    typedef enum {
        ...
        ImGuiHoveredFlags_AllowedMaskForIsWindowHovered = ImGuiHoveredFlags_ChildWindows | ImGuiHoveredFlags_RootWindow | ImGuiHoveredFlags_AnyWindow | ImGuiHoveredFlags_NoPopupHierarchy | ImGuiHoveredFlags_DockHierarchy |
                                                          ImGuiHoveredFlags_AllowWhenBlockedByPopup | ImGuiHoveredFlags_AllowWhenBlockedByActiveItem | ImGuiHoveredFlags_ForTooltip | ImGuiHoveredFlags_Stationary,
        ImGuiHoveredFlags_AllowedMaskForIsItemHovered = ImGuiHoveredFlags_AllowWhenBlockedByPopup | ImGuiHoveredFlags_AllowWhenBlockedByActiveItem | ImGuiHoveredFlags_AllowWhenOverlapped | ImGuiHoveredFlags_AllowWhenDisabled |
                                                        ImGuiHoveredFlags_NoNavOverride | ImGuiHoveredFlags_ForTooltip | ImGuiHoveredFlags_Stationary | ImGuiHoveredFlags_DelayMask_,
    ...
    typedef enum {
        ...
        ImGuiDockNodeFlags_LocalFlagsTransferMask_ = ImGuiDockNodeFlags_NoDockingSplit | ImGuiDockNodeFlags_NoResizeFlagsMask_ | ImGuiDockNodeFlags_AutoHideTabBar | ImGuiDockNodeFlags_CentralNode | ImGuiDockNodeFlags_NoTabBar |
                                                     ImGuiDockNodeFlags_HiddenTabBar | ImGuiDockNodeFlags_NoWindowMenuButton | ImGuiDockNodeFlags_NoCloseButton,
        ImGuiDockNodeFlags_SavedFlagsMask_ = ImGuiDockNodeFlags_NoResizeFlagsMask_ | ImGuiDockNodeFlags_DockSpace | ImGuiDockNodeFlags_CentralNode | ImGuiDockNodeFlags_NoTabBar | ImGuiDockNodeFlags_HiddenTabBar |
    ...
    typedef enum {
        ...
        ImGuiDebugLogFlags_EventMask_ = ImGuiDebugLogFlags_EventActiveId | ImGuiDebugLogFlags_EventFocus | ImGuiDebugLogFlags_EventPopup | ImGuiDebugLogFlags_EventNav | ImGuiDebugLogFlags_EventClipper | ImGuiDebugLogFlags_EventSelection |
                                        ImGuiDebugLogFlags_EventIO | ImGuiDebugLogFlags_EventInputRouting | ImGuiDebugLogFlags_EventDocking | ImGuiDebugLogFlags_EventViewport,
...
#pragma endregion
    ...
    inline ImVec2 GetContentRegionAvail() {
        using func_t = void (*)(ImVec2*);
        static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "igGetContentRegionAvail"));
        ImVec2 out;
        func(&out);
        return out;
    }
    inline ImVec2 GetContentRegionMax() {
        using func_t = void (*)(ImVec2*);
        static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "igGetContentRegionMax"));
        ImVec2 out;
        func(&out);
        return out;
    }
    ...
    inline ImVec2 GetFontTexUvWhitePixel() {
        using func_t = void (*)(ImVec2*);
        static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "igGetFontTexUvWhitePixel"));
        ImVec2 out;
        func(&out);
        return out;
    }
    ...
    inline ImVec2 GetCursorScreenPos() {
        using func_t = void (*)(ImVec2*);
        static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "igGetCursorScreenPos"));
        ImVec2 out;
        func(&out);
        return out;
    }
    ...
    inline ImVec2 GetCursorPos() {
        using func_t = void (*)(ImVec2*);
        static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "igGetCursorPos"));
        ImVec2 out;
        func(&out);
        return out;
    }
    ...
    inline ImVec2 GetCursorStartPos() {
        using func_t = void (*)(ImVec2*);
        static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "igGetCursorStartPos"));
        ImVec2 out;
        func(&out);
        return out;
    }
    ...
    inline void Image(ImTextureID user_texture_id, const ImVec2 image_size, const ImVec2 uv0 = ImVec2(0, 0), const ImVec2 uv1 = ImVec2(1, 1), const ImVec4 tint_col = ImVec4(1, 1, 1, 1), const ImVec4 border_col = ImVec4(0, 0, 0, 0)) {
    ...
    inline bool ImageButton(const char* str_id, ImTextureID user_texture_id, const ImVec2 image_size, const ImVec2 uv0 = ImVec2(0, 0), const ImVec2 uv1 = ImVec2(1, 1), const ImVec4 bg_col = ImVec4(0, 0, 0, 0),
    ...
    inline bool DragFloatRange2(const char* label, float* v_current_min, float* v_current_max, float v_speed = 1.0f, float v_min = 0.0f, float v_max = 0.0f, const char* format = "%.3f", const char* format_max = NULL,
    ...
    inline bool DragIntRange2(const char* label, int* v_current_min, int* v_current_max, float v_speed = 1.0f, int v_min = 0, int v_max = 0, const char* format = "%d", const char* format_max = NULL, ImGuiSliderFlags flags = 0) {
    ...
    inline bool DragScalar(const char* label, ImGuiDataType data_type, void* p_data, float v_speed = 1.0f, const void* p_min = NULL, const void* p_max = NULL, const char* format = NULL, ImGuiSliderFlags flags = 0) {
    ...
    inline bool VSliderScalar(const char* label, const ImVec2 size, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format = NULL, ImGuiSliderFlags flags = 0) {
    ...
    inline bool InputScalarN(const char* label, ImGuiDataType data_type, void* p_data, int components, const void* p_step = NULL, const void* p_step_fast = NULL, const char* format = NULL, ImGuiInputTextFlags flags = 0) {
    ...
    inline void PlotLines(const char* label, const float* values, int values_count, int values_offset = 0, const char* overlay_text = NULL, float scale_min = FLT_MAX, float scale_max = FLT_MAX, ImVec2 graph_size = ImVec2(0, 0),
    ...
    inline void PlotLines(const char* label, float (*values_getter)(void* data, int idx), void* data, int values_count, int values_offset = 0, const char* overlay_text = NULL, float scale_min = FLT_MAX, float scale_max = FLT_MAX,
    ...
    inline void PlotHistogram(const char* label, const float* values, int values_count, int values_offset = 0, const char* overlay_text = NULL, float scale_min = FLT_MAX, float scale_max = FLT_MAX, ImVec2 graph_size = ImVec2(0, 0),
                              int stride = sizeof(float)) {
        using func_t = void (*)(const char*, const float*, int, int, const char*, float, float, ImVec2, int);
        func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "igPlotHistogram_FloatPtr"));
        return func(label, values, values_count, values_offset, overlay_text, scale_min, scale_max, graph_size, stride);
    }
    inline void PlotHistogram(const char* label, float (*values_getter)(void* data, int idx), void* data, int values_count, int values_offset = 0, const char* overlay_text = NULL, float scale_min = FLT_MAX, float scale_max = FLT_MAX,
                              ImVec2 graph_size = ImVec2(0, 0)) {
        using func_t = void (*)(const char*, float (*)(void*, int), void*, int, int, const char*, float, float, ImVec2);
    ...
    inline ImVec2 GetItemRectMin() {
        using func_t = void (*)(ImVec2*);
        static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "igGetItemRectMin"));
        ImVec2 out;
        func(&out);
        return out;
    }
    inline ImVec2 GetItemRectMax() {
        using func_t = void (*)(ImVec2*);
        static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "igGetItemRectMax"));
        ImVec2 out;
        func(&out);
        return out;
    }
    inline ImVec2 GetItemRectSize() {
        using func_t = void (*)(ImVec2*);
        static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "igGetItemRectSize"));
        ImVec2 out;
        func(&out);
        return out;
    }
    ...
    inline ImVec2 CalcTextSize(const char* text, const char* text_end = nullptr, bool hide_text_after_double_hash = false, float wrap_width = 0) {
        using func_t = void (*)(ImVec2*, const char*, const char*, bool, float);
        static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "igCalcTextSize"));
        ImVec2 out;
    ...
    inline ImVec4 ColorConvertU32ToFloat4(ImU32 in) {
        ...
        static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "igColorConvertU32ToFloat4"));
        ImVec4 out;
        func(&out, in);
        return out;
    }
    ...
    inline ImVec2 GetMousePos() {
        using func_t = void (*)(ImVec2*);
        static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "igGetMousePos"));
        ImVec2 out;
        func(&out);
        return out;
    }
    inline ImVec2 GetMousePosOnOpeningCurrentPopup() {
        using func_t = void (*)(ImVec2*);
        static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "igGetMousePosOnOpeningCurrentPopup"));
        ImVec2 out;
        func(&out);
        return out;
    }
    ...
    inline ImVec2 GetMouseDragDelta(ImGuiMouseButton button, float lock_threshold) {
        ...
        static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "igGetMouseDragDelta"));
        ImVec2 out;
    ...
    namespace ImGuiTableColumnSortSpecsManager {
        inline ImGuiTableColumnSortSpecs* Create(void) {
            ...
            func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "ImGuiTableColumnSortSpecs_ImGuiTableColumnSortSpecs"));
            return func();
        }
    ...
    namespace ImGuiInputTextCallbackDataManager {
        ...
        inline ImGuiInputTextCallbackData* Create(void) {
            ...
            func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "ImGuiInputTextCallbackData_ImGuiInputTextCallbackData"));
            return func();
        }
        ...
        inline void ClearSelection(ImGuiInputTextCallbackData* self) {
            using func_t = void (*)(ImGuiInputTextCallbackData*);
            func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "ImGuiInputTextCallbackData_ClearSelection"));
            return func(self);
        }
        inline bool HasSelection(ImGuiInputTextCallbackData* self) {
            using func_t = bool (*)(ImGuiInputTextCallbackData*);
            func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "ImGuiInputTextCallbackData_HasSelection"));
            return func(self);
        }
    ...
    namespace ImGuiOnceUponAFrameManager {
        inline ImGuiOnceUponAFrame* Create(void) {
            ...
            func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "ImGuiOnceUponAFrame_ImGuiOnceUponAFrame"));
            return func();
        }
    ...
    namespace ImGuiStoragePairManger {
        ...
        inline ImGuiStoragePair* Create(ImGuiID _key, float _val) {
            ...
            func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "ImGuiStoragePair_ImGuiStoragePair_Float"));
            return func(_key, _val);
        }
    ...
    namespace ImColorManager {
        ...
        inline ImColor HSV(float h, float s, float v, float a) {
            using func_t = void (*)(ImColor*, float, float, float, float);
            static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "ImColor_HSV"));
            ImColor out;
            func(&out, h, s, v, a);
            return out;
        }
    ...
    namespace ImDrawListManager {
        ...
        inline ImVec2 GetClipRectMin(ImDrawList* self) {
            ...
            static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "ImDrawList_GetClipRectMin"));
            ImVec2 out;
            func(&out, self);
            return out;
        }
        inline ImVec2 GetClipRectMax(ImDrawList* self) {
            using func_t = void (*)(ImVec2*, ImDrawList*);
            static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "ImDrawList_GetClipRectMax"));
            ImVec2 out;
            func(&out, self);
            return out;
        }
        ...
        inline void AddText(ImDrawList* self, const ImFont* font, float font_size, const ImVec2 pos, ImU32 col, const char* text_begin, const char* text_end = 0, float wrap_width = 0.0f, const ImVec4* cpu_fine_clip_rect = nullptr) {
    ...
    namespace ImFontGlyphRangesBuilderManager {
        ...
        inline ImFontGlyphRangesBuilder* Create(void) {
            ...
            func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "ImFontGlyphRangesBuilder_ImFontGlyphRangesBuilder"));
            return func();
        }
    ...
    namespace ImFontAtlasCustomRectManager {
        inline ImFontAtlasCustomRect* Create(void) {
            ...
            func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "ImFontAtlasCustomRect_ImFontAtlasCustomRect"));
            return func();
        }
    ...
    namespace ImFontAtlasManager {
        ...
        inline ImFont* AddFontFromMemoryCompressedTTF(ImFontAtlas* self, const void* compressed_font_data, int compressed_font_data_size, float size_pixels, const ImFontConfig* font_cfg, const ImWchar* glyph_ranges) {
            ...
            func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "ImFontAtlas_AddFontFromMemoryCompressedTTF"));
        ...
        inline ImFont* AddFontFromMemoryCompressedBase85TTF(ImFontAtlas* self, const char* compressed_font_data_base85, float size_pixels, const ImFontConfig* font_cfg, const ImWchar* glyph_ranges) {
            using func_t = ImFont* (*)(ImFontAtlas*, const char*, float, const ImFontConfig*, const ImWchar*);
            func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "ImFontAtlas_AddFontFromMemoryCompressedBase85TTF"));
        ...
        inline const ImWchar* GetGlyphRangesChineseSimplifiedCommon(ImFontAtlas* self) {
            using func_t = const ImWchar* (*)(ImFontAtlas*);
            func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "ImFontAtlas_GetGlyphRangesChineseSimplifiedCommon"));
            return func(self);
        }
    ...
    namespace ImFontManger {
        ...
        inline ImVec2 CalcTextSizeA(ImFont* self, float size, float max_width, float wrap_width, const char* text_begin, const char* text_end, const char** remaining) {
            ...
            static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "ImFont_CalcTextSizeA"));
            ImVec2 out;
    ...
    namespace ImGuiViewportManager {
        ...
        inline ImVec2 GetCenter(ImGuiViewport* self) {
            ...
            static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "ImGuiViewport_GetCenter"));
            ImVec2 out;
            func(&out, self);
            return out;
        }
        inline ImVec2 GetWorkCenter(ImGuiViewport* self) {
            using func_t = void (*)(ImVec2*, ImGuiViewport*);
            static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "ImGuiViewport_GetWorkCenter"));
            ImVec2 out;
            func(&out, self);
            return out;
        }
    ...
    namespace ImGuiPlatformMonitorManager {
        inline ImGuiPlatformMonitor* Create(void) {
            ...
            func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "ImGuiPlatformMonitor_ImGuiPlatformMonitor"));
            return func();
        }
    ...
    namespace ImGuiPlatformImeDataManager {
        inline ImGuiPlatformImeData* Create(void) {
            ...
            func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "ImGuiPlatformImeData_ImGuiPlatformImeData"));
            return func();
        }
    ...
    inline ImVec2 ImMin(const ImVec2 lhs, const ImVec2 rhs) {
        ...
        static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "igImMin"));
        ImVec2 out;
        func(&out, lhs, rhs);
        return out;
    }
    inline ImVec2 ImMax(const ImVec2 lhs, const ImVec2 rhs) {
        using func_t = void (*)(ImVec2*, const ImVec2, const ImVec2);
        static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "igImMax"));
        ImVec2 out;
        func(&out, lhs, rhs);
        return out;
    }
    inline ImVec2 ImClamp(const ImVec2 v, const ImVec2 mn, const ImVec2 mx) {
        ...
        static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "igImClamp"));
        ImVec2 out;
        func(&out, v, mn, mx);
        return out;
    }
    inline ImVec2 ImLerp(const ImVec2 a, const ImVec2 b, float t) {
        ...
        static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "igImLerp_Vec2Float"));
        ImVec2 out;
        func(&out, a, b, t);
        return out;
    }
    inline ImVec2 ImLerp(const ImVec2 a, const ImVec2 b, const ImVec2 t) {
        using func_t = void (*)(ImVec2*, const ImVec2, const ImVec2, const ImVec2);
        static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "igImLerp_Vec2Vec2"));
        ImVec2 out;
        func(&out, a, b, t);
        return out;
    }
    inline ImVec4 ImLerp(const ImVec4 a, const ImVec4 b, float t) {
        ...
        static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "igImLerp_Vec4"));
        ImVec4 out;
        func(&out, a, b, t);
        return out;
    }
    ...
    inline ImVec2 ImTrunc(const ImVec2 v) {
        ...
        static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "igImTrunc_Vec2"));
        ImVec2 out;
        func(&out, v);
        return out;
    }
    ...
    inline ImVec2 ImFloor(const ImVec2 v) {
        using func_t = void (*)(ImVec2*, const ImVec2);
        static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "igImFloor_Vec2"));
        ImVec2 out;
        func(&out, v);
        return out;
    }
    ...
    inline ImVec2 ImRotate(const ImVec2 v, float cos_a, float sin_a) {
        ...
        static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "igImRotate"));
        ImVec2 out;
    ...
    inline ImVec2 ImMul(const ImVec2 lhs, const ImVec2 rhs) {
        using func_t = void (*)(ImVec2*, const ImVec2, const ImVec2);
        static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "igImMul"));
        ImVec2 out;
        func(&out, lhs, rhs);
        return out;
    }
    ...
    inline ImVec2 ImBezierCubicCalc(const ImVec2 p1, const ImVec2 p2, const ImVec2 p3, const ImVec2 p4, float t) {
        ...
        static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "igImBezierCubicCalc"));
        ImVec2 out;
    ...
    inline ImVec2 ImBezierCubicClosestPoint(const ImVec2 p1, const ImVec2 p2, const ImVec2 p3, const ImVec2 p4, const ImVec2 p, int num_segments) {
        ...
        static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "igImBezierCubicClosestPoint"));
        ImVec2 out;
    ...
    inline ImVec2 ImBezierCubicClosestPointCasteljau(const ImVec2 p1, const ImVec2 p2, const ImVec2 p3, const ImVec2 p4, const ImVec2 p, float tess_tol) {
        ...
        static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "igImBezierCubicClosestPointCasteljau"));
        ImVec2 out;
    ...
    inline ImVec2 ImBezierQuadraticCalc(const ImVec2 p1, const ImVec2 p2, const ImVec2 p3, float t) {
        ...
        static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "igImBezierQuadraticCalc"));
        ImVec2 out;
        func(&out, p1, p2, p3, t);
        return out;
    }
    inline ImVec2 ImLineClosestPoint(const ImVec2 a, const ImVec2 b, const ImVec2 p) {
        using func_t = void (*)(ImVec2*, const ImVec2, const ImVec2, const ImVec2);
        static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "igImLineClosestPoint"));
        ImVec2 out;
        func(&out, a, b, p);
        return out;
    }
    ...
    inline ImVec2 ImTriangleClosestPoint(const ImVec2 a, const ImVec2 b, const ImVec2 c, const ImVec2 p) {
        ...
        static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "igImTriangleClosestPoint"));
        ImVec2 out;
        func(&out, a, b, c, p);
        return out;
    }
    ...
    namespace ImRectManager {
        ...
        inline ImVec2 GetCenter(ImRect* self) {
            ...
            static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "ImRect_GetCenter"));
            ImVec2 out;
            func(&out, self);
            return out;
        }
        inline ImVec2 GetSize(ImRect* self) {
            using func_t = void (*)(ImVec2*, ImRect*);
            static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "ImRect_GetSize"));
            ImVec2 out;
            func(&out, self);
            return out;
        }
        ...
        inline ImVec2 GetTL(ImRect* self) {
            using func_t = void (*)(ImVec2*, ImRect*);
            static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "ImRect_GetTL"));
            ImVec2 out;
            func(&out, self);
            return out;
        }
        inline ImVec2 GetTR(ImRect* self) {
            using func_t = void (*)(ImVec2*, ImRect*);
            static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "ImRect_GetTR"));
            ImVec2 out;
            func(&out, self);
            return out;
        }
        inline ImVec2 GetBL(ImRect* self) {
            using func_t = void (*)(ImVec2*, ImRect*);
            static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "ImRect_GetBL"));
            ImVec2 out;
            func(&out, self);
            return out;
        }
        inline ImVec2 GetBR(ImRect* self) {
            using func_t = void (*)(ImVec2*, ImRect*);
            static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "ImRect_GetBR"));
            ImVec2 out;
            func(&out, self);
            return out;
        }
        ...
        inline ImVec4 ToVec4(ImRect* self) {
            ...
            static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "ImRect_ToVec4"));
            ImVec4 out;
            func(&out, self);
            return out;
        }
    ...
    namespace ImDrawListSharedDataManager {
        ...
        inline void SetCircleTessellationMaxError(ImDrawListSharedData* self, float max_error) {
            ...
            func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "ImDrawListSharedData_SetCircleTessellationMaxError"));
    ...
    namespace ImGuiComboPreviewDataManager {
        ...
        inline ImGuiComboPreviewData* Create(void) {
            ...
            func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "ImGuiComboPreviewData_ImGuiComboPreviewData"));
            return func();
        }
    ...
    namespace ImGuiInputTextDeactivatedStateManager {
        inline ImGuiInputTextDeactivatedState* Create(void) {
            ...
            func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "ImGuiInputTextDeactivatedState_ImGuiInputTextDeactivatedState"));
            return func();
        }
    ...
    namespace ImGuiInputTextDeactivatedStateManager {
        ...
        inline void ClearFreeMemory(ImGuiInputTextDeactivatedState* self) {
            using func_t = void (*)(ImGuiInputTextDeactivatedState*);
            func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "ImGuiInputTextDeactivatedState_ClearFreeMemory"));
            return func(self);
        }
    }
    ...
    namespace ImGuiInputTextStateManager {
        ...
        inline void ReloadUserBufAndSelectAll(ImGuiInputTextState* self) {
            using func_t = void (*)(ImGuiInputTextState*);
            func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "ImGuiInputTextState_ReloadUserBufAndSelectAll"));
            return func(self);
        }
        inline void ReloadUserBufAndKeepSelection(ImGuiInputTextState* self) {
            using func_t = void (*)(ImGuiInputTextState*);
            func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "ImGuiInputTextState_ReloadUserBufAndKeepSelection"));
            return func(self);
        }
        inline void ReloadUserBufAndMoveToEnd(ImGuiInputTextState* self) {
            using func_t = void (*)(ImGuiInputTextState*);
            func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "ImGuiInputTextState_ReloadUserBufAndMoveToEnd"));
            return func(self);
        }
    ...
    namespace ImGuiNextWindowDataManager {
        inline ImGuiNextWindowData* Create(void) {
            ...
            func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "ImGuiNextWindowData_ImGuiNextWindowData"));
            return func();
        }
    ...
    namespace ImGuiKeyRoutingTableManager {
        inline ImGuiKeyRoutingTable* Create(void) {
            ...
            func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "ImGuiKeyRoutingTable_ImGuiKeyRoutingTable"));
            return func();
        }
    ...
    namespace ImGuiTypingSelectStateManager {
        inline ImGuiTypingSelectState* Create(void) {
            ...
            func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "ImGuiTypingSelectState_ImGuiTypingSelectState"));
            return func();
        }
    ...
    namespace ImGuiDockNodeManager {
        ...
        inline ImRect Rect(ImGuiDockNode* self) {
            ...
            static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "ImGuiDockNode_Rect"));
            ImRect out;
            func(&out, self);
            return out;
        }
    ...
    namespace ImGuiViewportPManager {
        ...
        inline ImVec2 CalcWorkRectPos(ImGuiViewportP* self, const ImVec2 off_min) {
            ...
            static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "ImGuiViewportP_CalcWorkRectPos"));
            ImVec2 out;
        ...
        inline ImVec2 CalcWorkRectSize(ImGuiViewportP* self, const ImVec2 off_min, const ImVec2 off_max) {
            ...
            static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "ImGuiViewportP_CalcWorkRectSize"));
            ImVec2 out;
        ...
        inline ImRect GetMainRect(ImGuiViewportP* self) {
            ...
            static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "ImGuiViewportP_GetMainRect"));
            ImRect out;
            func(&out, self);
            return out;
        }
        inline ImRect GetWorkRect(ImGuiViewportP* self) {
            using func_t = void (*)(ImRect*, ImGuiViewportP*);
            static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "ImGuiViewportP_GetWorkRect"));
            ImRect out;
            func(&out, self);
            return out;
        }
        inline ImRect GetBuildWorkRect(ImGuiViewportP* self) {
            using func_t = void (*)(ImRect*, ImGuiViewportP*);
            static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "ImGuiViewportP_GetBuildWorkRect"));
            ImRect out;
            func(&out, self);
            return out;
        }
    ...
    namespace ImGuiWindowManager {
        ...
        inline ImRect Rect(ImGuiWindow* self) {
            ...
            static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "ImGuiWindow_Rect"));
            ImRect out;
            func(&out, self);
            return out;
        }
        ...
        inline ImRect TitleBarRect(ImGuiWindow* self) {
            using func_t = void (*)(ImRect*, ImGuiWindow*);
            static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "ImGuiWindow_TitleBarRect"));
            ImRect out;
            func(&out, self);
            return out;
        }
        inline ImRect MenuBarRect(ImGuiWindow* self) {
            using func_t = void (*)(ImRect*, ImGuiWindow*);
            static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "ImGuiWindow_MenuBarRect"));
            ImRect out;
            func(&out, self);
            return out;
        }
    ...
    namespace ImGuiTableInstanceDataManager {
        inline ImGuiTableInstanceData* Create(void) {
            ...
            func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "ImGuiTableInstanceData_ImGuiTableInstanceData"));
            return func();
        }
    ...
    namespace ImGuiTableColumnSettingsManager {
        inline ImGuiTableColumnSettings* Create(void) {
            ...
            func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "ImGuiTableColumnSettings_ImGuiTableColumnSettings"));
            return func();
        }
    ...
    inline ImVec2 CalcWindowNextAutoFitSize(ImGuiWindow* window) {
        ...
        static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "igCalcWindowNextAutoFitSize"));
        ImVec2 out;
        func(&out, window);
        return out;
    }
    ...
    inline void SetWindowHiddenAndSkipItemsForCurrentFrame(ImGuiWindow* window) {
        using func_t = void (*)(ImGuiWindow*);
        func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "igSetWindowHiddenAndSkipItemsForCurrentFrame"));
        return func(window);
    }
    ...
    inline ImRect WindowRectAbsToRel(ImGuiWindow* window, const ImRect r) {
        ...
        static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "igWindowRectAbsToRel"));
        ImRect out;
        func(&out, window, r);
        return out;
    }
    inline ImRect WindowRectRelToAbs(ImGuiWindow* window, const ImRect r) {
        using func_t = void (*)(ImRect*, ImGuiWindow*, const ImRect);
        static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "igWindowRectRelToAbs"));
        ImRect out;
        func(&out, window, r);
        return out;
    }
    inline ImVec2 WindowPosRelToAbs(ImGuiWindow* window, const ImVec2 p) {
        ...
        static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "igWindowPosRelToAbs"));
        ImVec2 out;
        func(&out, window, p);
        return out;
    }
    ...
    inline ImGuiWindow* FindBottomMostVisibleWindowWithinBeginStack(ImGuiWindow* window) {
        ...
        func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "igFindBottomMostVisibleWindowWithinBeginStack"));
        return func(window);
    }
    ...
    inline ImGuiViewportP* FindHoveredViewportFromPlatformWindowStack(const ImVec2 mouse_platform_pos) {
        ...
        func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "igFindHoveredViewportFromPlatformWindowStack"));
    ...
    inline ImVec2 ScrollToRectEx(ImGuiWindow* window, const ImRect rect, ImGuiScrollFlags flags) {
        ...
        static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "igScrollToRectEx"));
        ImVec2 out;
    ...
    inline ImVec2 CalcItemSize(ImVec2 size, float default_w, float default_h) {
        ...
        static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "igCalcItemSize"));
        ImVec2 out;
    ...
    inline ImVec2 GetContentRegionMaxAbs() {
        using func_t = void (*)(ImVec2*);
        static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "igGetContentRegionMaxAbs"));
        ImVec2 out;
        func(&out);
        return out;
    }
    ...
    inline ImRect GetPopupAllowedExtentRect(ImGuiWindow* window) {
        using func_t = void (*)(ImRect*, ImGuiWindow*);
        static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "igGetPopupAllowedExtentRect"));
        ImRect out;
        func(&out, window);
        return out;
    }
    ...
    inline ImVec2 FindBestWindowPosForPopup(ImGuiWindow* window) {
        using func_t = void (*)(ImVec2*, ImGuiWindow*);
        static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "igFindBestWindowPosForPopup"));
        ImVec2 out;
        func(&out, window);
        return out;
    }
    inline ImVec2 FindBestWindowPosForPopupEx(const ImVec2 ref_pos, const ImVec2 size, ImGuiDir* last_dir, const ImRect r_outer, const ImRect r_avoid, ImGuiPopupPositionPolicy policy) {
        ...
        static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "igFindBestWindowPosForPopupEx"));
        ImVec2 out;
    ...
    inline ImVec2 GetKeyMagnitude2d(ImGuiKey key_left, ImGuiKey key_right, ImGuiKey key_up, ImGuiKey key_down) {
        ...
        static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "igGetKeyMagnitude2d"));
        ImVec2 out;
    ...
    inline ImRect TableGetCellBgRect(const ImGuiTable* table, int column_n) {
        ...
        static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "igTableGetCellBgRect"));
        ImRect out;
    ...
    inline void TableGcCompactTransientBuffers(ImGuiTableTempData* table) {
        using func_t = void (*)(ImGuiTableTempData*);
        func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "igTableGcCompactTransientBuffers_TableTempDataPtr"));
        return func(table);
    }
    ...
    inline ImGuiTabItem* TabBarFindMostRecentlySelectedTabForActiveWindow(ImGuiTabBar* tab_bar) {
        ...
        func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "igTabBarFindMostRecentlySelectedTabForActiveWindow"));
        return func(tab_bar);
    }
    ...
    inline ImVec2 TabItemCalcSize(const char* label, bool has_close_button_or_unsaved_marker) {
        ...
        static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "igTabItemCalcSize_Str"));
        ImVec2 out;
    ...
    inline ImVec2 TabItemCalcSize(ImGuiWindow* window) {
        using func_t = void (*)(ImVec2*, ImGuiWindow*);
        static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "igTabItemCalcSize_WindowPtr"));
        ImVec2 out;
        func(&out, window);
        return out;
    }
    ...
    inline void TabItemLabelAndCloseButton(ImDrawList* draw_list, const ImRect bb, ImGuiTabItemFlags flags, ImVec2 frame_padding, const char* label, ImGuiID tab_id, ImGuiID close_button_id, bool is_contents_visible, bool* out_just_closed,
    ...
    inline ImRect GetWindowScrollbarRect(ImGuiWindow* window, ImGuiAxis axis) {
        ...
        static func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "igGetWindowScrollbarRect"));
        ImRect out;
    ...
    inline int PlotEx(ImGuiPlotType plot_type, const char* label, float (*values_getter)(void* data, int idx), void* data, int values_count, int values_offset, const char* overlay_text, float scale_min, float scale_max,
    ...
    inline void ErrorCheckUsingSetCursorPosToExtendParentBoundaries() {
        using func_t = void (*)();
        func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "igErrorCheckUsingSetCursorPosToExtendParentBoundaries"));
        return func();
    }
    ...
    inline void ImFontAtlasBuildRender32bppRectFromString(ImFontAtlas* atlas, int x, int y, int w, int h, const char* in_str, char in_marker_char, unsigned int in_marker_pixel_value) {
        ...
        func_t func = reinterpret_cast<func_t>(GetProcAddress(menuFramework, "igImFontAtlasBuildRender32bppRectFromString"));
        return func(atlas, x, y, w, h, in_str, in_marker_char, in_marker_pixel_value);
    }
